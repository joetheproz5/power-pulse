const CACHE = "hart-el-sett-power-v22";
const APP_FILES = ["./", "./index.html", "./styles.css?v=20260910.8", "./refinements.css?v=20260910.14", "./light.css?v=20260910.9", "./app.js?v=20260910.12", "./assets/home-3d.jpg", "./manifest.webmanifest", "./icon.svg"];
